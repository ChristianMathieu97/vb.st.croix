...
Public Class WkstAndMemoReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KC01.WkstAndMemoReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ShowMemo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWkstAndMemoReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WkstAndMemoReport = New WkstAndMemoReport
        rpt.Site = Me.Site
        Return rpt
    End Function
