...
Public Class WkstOnlyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KC01.WkstOnlyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWkstOnlyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WkstOnlyReport = New WkstOnlyReport
        rpt.Site = Me.Site
        Return rpt
    End Function
